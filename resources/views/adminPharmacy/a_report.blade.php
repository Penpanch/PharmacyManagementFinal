...
<head>
  ...
  <title>Pharmacy Management System | รายงานการขาย</title>
...
@endsection
  ...
  <div class="grid_12">
    <ul id="q_nav">
      <li><a href="{{url('/homeAd')}}">หน้าหลัก</a></li>
      <li><a href="#">/</a></li>
      <li><a href="{{url('/reportAd')}}"  class="active">รายงานการขาย</a></li>
    </ul>
    <div class="clear"></div>
    <hr />
     ...
     <div class="panel panel-default">    
          ...
          <form action="reportAd2" method="post" role="form">
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-8">
                        ...
                        <a href="{{ url('reportAd2/pdf')}}" class="btn btn-danger">Convert into PDF</a>
          <a href="{{ url('reportAd2/pdfdown')}}" class="btn btn-danger">Download to PDF</a>
                   ...
                   <?php
                    ...
                    @foreach($result as $var)
                     <tr>
                            ...
                            <td><center>{{$var->amout * $var->price }}</center></td>
