...
<head>
  ...
  <title>Pharmacy Management System | กราฟ</title>
...
@endsection
  ...
  <div class="grid_12">
    <ul id="q_nav">
      <li><a href="{{url('/homeAd')}}">หน้าหลัก</a></li>
      <li><a href="#">/</a></li>
      <li><a href="#"  class="active">กราฟ</a></li>
    </ul>
    <div class="clear"></div>
    <hr />

    <a href="{{ url('graphmonthAd')}}" class="btn btn-danger">กราฟแสดงการขายตามเดือน</a>
          <a href="{{ url('graphyearAd')}}" class="btn btn-danger">กราฟแสดงการขายตามปี</a>
